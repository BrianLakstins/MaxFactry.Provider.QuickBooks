// <copyright file="MaxQBItemDiscountEntity.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.BusinessLayer
{
    ...
    public class MaxQBItemDiscountEntity : MaxQBBaseEntity
    {

        /// <summary>
        /// Initializes a new instance of the MaxQBItemDiscountEntity class
        /// </summary>
        /// <param name="loData">object to hold data</param>
        public MaxQBItemDiscountEntity(MaxData loData) : base(loData)
		{
		}
        ...
        public MaxQBItemDiscountEntity(Type loDataModelType)
        ...
        public string ItemDesc
        {
            get
            {
                return this.GetString(this.DataModel.ItemDesc);
            }

            set
            {
                this.Set(this.DataModel.ItemDesc, value);
            }
        }
        ...
        public string ORDiscountRate
        {
            get
            {
                return this.GetString(this.DataModel.ORDiscountRate);
            }

            set
            {
                this.Set(this.DataModel.ORDiscountRate, value);
            }
        }
        ...
        public string AccountRef
        {
            get
            {
                return this.GetString(this.DataModel.AccountRef);
            }

            set
            {
                this.Set(this.DataModel.AccountRef, value);
            }
        }
        ...
        /// </summary>
        protected MaxQBItemDiscountDataModel DataModel
        {
            get
            {
                return (MaxQBItemDiscountDataModel)MaxDataLibrary.GetDataModel(this.DataModelType);
            }
        }

        public static MaxQBItemDiscountEntity Create()
        {
            return MaxBusinessLibrary.GetEntity(
                typeof(MaxQBItemDiscountEntity),
                typeof(MaxQBItemDiscountDataModel)) as MaxQBItemDiscountEntity;
        }
    }
}
