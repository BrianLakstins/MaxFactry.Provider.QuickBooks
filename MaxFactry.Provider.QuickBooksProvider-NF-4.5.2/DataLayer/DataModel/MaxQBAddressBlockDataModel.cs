// <copyright file="MaxQBAddressBlockDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBAddressBlockDataModel : MaxQBBaseDataModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBAddressBlockDataModel class
        /// </summary>
        public MaxQBAddressBlockDataModel()
        {
            this.SetDataStorageName("MaxQBAddressBlock");
