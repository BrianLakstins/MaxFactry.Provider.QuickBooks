// <copyright file="MaxQBBaseRefDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBBaseRefDataModel : MaxQBBaseDataModel
    {
        ...
        /// </summary>
        public MaxQBBaseRefDataModel()
        {
            this.AddNullable(this.ListID, typeof(string));
            this.AddNullable(this.FullName, typeof(string));
        }
    }
}
