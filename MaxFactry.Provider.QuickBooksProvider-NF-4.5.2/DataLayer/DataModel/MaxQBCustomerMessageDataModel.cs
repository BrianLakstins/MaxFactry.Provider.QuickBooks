// <copyright file="MaxQBCustomerMessageDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBCustomerMessageDataModel : MaxQBBaseDataModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBCustomerMessageDataModel class
        /// </summary>
        public MaxQBCustomerMessageDataModel()
        {
            this.SetDataStorageName("MaxQBCustomerMessage");
