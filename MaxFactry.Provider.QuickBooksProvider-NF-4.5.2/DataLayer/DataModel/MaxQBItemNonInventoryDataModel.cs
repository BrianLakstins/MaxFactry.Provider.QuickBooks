// <copyright file="MaxQBItemNonInventoryDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemNonInventoryDataModel : MaxQBBaseDataModel
    {
        ...
        public readonly string ORSalesAndPurchase = "ORSalesAndPurchase";

        public readonly string ORSalesOrPurchase = "ORSalesOrPurchase";
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBItemNonInventoryDataModel class
        /// </summary>
        public MaxQBItemNonInventoryDataModel()
        {
            this.SetDataStorageName("MaxQBItemNonInventory");
            ...
            this.AddNullable(this.ORSalesAndPurchase, typeof(MaxLongString));
            this.AddNullable(this.ORSalesOrPurchase, typeof(MaxLongString));
