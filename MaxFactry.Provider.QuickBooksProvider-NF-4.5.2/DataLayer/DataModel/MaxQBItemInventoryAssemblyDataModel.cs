// <copyright file="MaxQBItemInventoryAssemblyDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemInventoryAssemblyDataModel : MaxQBBaseDataModel
    {
        ...
        public readonly string BuildPoint = "BuildPoint";
        ...
        public readonly string ItemInventoryAssemblyLineList = "ItemInventoryAssemblyLineList";

        public readonly string DataExtRetList = "DataExtRetList";

        /// <summary>
        /// Initializes a new instance of the MaxQBItemInventoryAssemblyDataModel class
        /// </summary>
        public MaxQBItemInventoryAssemblyDataModel()
        {
            this.SetDataStorageName("MaxQBItemInventoryAssembly");
            ...
            this.AddNullable(this.ManufacturerPartNumber, typeof(MaxShortString));
            ...
            this.AddNullable(this.BuildPoint, typeof(double));
            ...
            this.AddNullable(this.ItemInventoryAssemblyLineList, typeof(MaxLongString));
