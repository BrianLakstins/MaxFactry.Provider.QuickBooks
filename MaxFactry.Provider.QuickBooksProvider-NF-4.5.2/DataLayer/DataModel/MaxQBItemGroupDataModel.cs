// <copyright file="MaxQBItemGroupDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemGroupDataModel : MaxQBBaseDataModel
    {
        ...
        public readonly string IsPrintItemsInGroup = "IsPrintItemsInGroup";

        public readonly string SpecialItemType = "SpecialItemType";

        public readonly string ExternalGUID = "ExternalGUID";

        public readonly string ItemGroupLineList = "ItemGroupLineList";

        public readonly string DataExtRetList = "DataExtRetList";

        /// <summary>
        /// Initializes a new instance of the MaxQBItemGroupDataModel class
        /// </summary>
        public MaxQBItemGroupDataModel()
        {
            this.SetDataStorageName("MaxQBItemGroup");
            ...
            this.AddNullable(this.IsPrintItemsInGroup, typeof(bool));
            this.AddNullable(this.SpecialItemType, typeof(int));
            this.AddNullable(this.ExternalGUID, typeof(MaxShortString));
            this.AddNullable(this.ItemGroupLineList, typeof(MaxLongString));
