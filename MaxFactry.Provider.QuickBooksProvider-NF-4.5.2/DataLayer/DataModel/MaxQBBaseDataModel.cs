// <copyright file="MaxQBBaseDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBBaseDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
    {
