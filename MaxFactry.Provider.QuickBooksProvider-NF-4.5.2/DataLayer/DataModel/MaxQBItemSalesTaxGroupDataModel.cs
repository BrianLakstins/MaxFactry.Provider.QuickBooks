// <copyright file="MaxQBItemSalesTaxGroupDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemSalesTaxGroupDataModel : MaxQBBaseDataModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBItemSalesTaxGroupDataModel class
        /// </summary>
        public MaxQBItemSalesTaxGroupDataModel()
        {
            this.SetDataStorageName("MaxQBItemSalesTaxGroup");
