// <copyright file="MaxQBStandardTermsDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBStandardTermsDataModel : MaxQBBaseDataModel
    {
        ...
        public readonly string StdDueDays = "StdDueDays";

        public readonly string StdDiscountDays = "StdDiscountDays";

        public readonly string DiscountPct = "DiscountPct";

        /// <summary>
        /// Initializes a new instance of the MaxQBStandardTermsDataModel class
        /// </summary>
        public MaxQBStandardTermsDataModel()
        {
            ...
            this.AddNullable(this.StdDueDays, typeof(int));
            this.AddNullable(this.StdDiscountDays, typeof(int));
            this.AddNullable(this.DiscountPct, typeof(double));
        }
    }
}
