// <copyright file="MaxQBItemSubtotalDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemSubtotalDataModel : MaxQBBaseDataModel
    {
        ...
        public readonly string SubtotalCodeRef = "SubtotalCodeRef";
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBItemSubtotalDataModel class
        /// </summary>
        public MaxQBItemSubtotalDataModel()
        {
            this.SetDataStorageName("MaxQBItemSubtotal");
            ...
            this.AddNullable(this.SubtotalCodeRef, typeof(MaxShortString));
