// <copyright file="MaxQBItemPaymentDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemPaymentDataModel : MaxQBBaseDataModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBItemPaymentDataModel class
        /// </summary>
        public MaxQBItemPaymentDataModel()
        {
            this.SetDataStorageName("MaxQBItemPayment");
