// <copyright file="MaxQBItemSalesTaxDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemSalesTaxDataModel : MaxQBBaseDataModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBItemSalesTaxDataModel class
        /// </summary>
        public MaxQBItemSalesTaxDataModel()
        {
            this.SetDataStorageName("MaxQBItemSalesTax");
