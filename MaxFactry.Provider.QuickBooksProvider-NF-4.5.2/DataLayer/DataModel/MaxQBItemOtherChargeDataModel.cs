// <copyright file="MaxQBItemOtherChargeDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// <summary>
    /// </summary>
    public class MaxQBItemOtherChargeDataModel : MaxQBBaseDataModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MaxQBItemOtherChargeDataModel class
        /// </summary>
        public MaxQBItemOtherChargeDataModel()
        {
            this.SetDataStorageName("MaxQBItemOtherCharge");
