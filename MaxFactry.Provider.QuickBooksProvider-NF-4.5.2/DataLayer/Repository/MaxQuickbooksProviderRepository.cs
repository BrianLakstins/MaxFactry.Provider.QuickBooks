// <copyright file="MaxQuickbooksProviderRepository.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider.DataLayer
{
    ...
    /// </summary>
    public class MaxQuickbooksProviderRepository : MaxFactry.Base.DataLayer.MaxBaseIdRepository
    {
