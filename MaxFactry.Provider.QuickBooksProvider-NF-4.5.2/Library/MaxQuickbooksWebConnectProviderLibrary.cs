// <copyright file="MaxQuickbooksProviderLibrary.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Provider.QuickbooksProvider
{
    ...
    public class MaxQuickbooksWebConnectProviderLibrary : MaxByMethodFactory
    {

        /// <summary>
        /// Internal storage of single object
        /// </summary>
        private static MaxQuickbooksWebConnectProviderLibrary _oInstance = null;
        ...
        /// </summary>
        public static MaxQuickbooksWebConnectProviderLibrary Instance
        {
            get
            {
                if (null == _oInstance)
                {
                    lock (_oLock)
                    {
                        if (null == _oInstance)
                        {
                            _oInstance = new MaxQuickbooksWebConnectProviderLibrary();
                        }
                    }
                }
        ...
        public static string GetServerVersion(string lsName, string lsTicket)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.GetServerVersion(lsTicket);
        }
        ...
        public static string GetClientVersion(string lsName, string lsVersion)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.GetClientVersion(lsVersion);
        }
        ...
        public static string[] Authenticate(string lsName, string lsUsername, string lsPassword)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.Authenticate(lsUsername, lsPassword);
        }
        ...
        public static string CloseConnection(string lsName, string lsTicket)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.CloseConnection(lsTicket);
        }
        ...
        public static string ConnectionError(string lsName, string lsTicket, string lsResult, string lsMessage)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.ConnectionError(lsTicket, lsResult, lsMessage);
        }
        ...
        public static string GetInteractiveURL(string lsName, string lsTicket, string lsSessionID)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.GetInteractiveURL(lsTicket, lsSessionID);
        }
        ...
        /// <param name="lsTicket">The ticket from the web connector.</param>
        /// <returns></returns>
        public static string GetLastError(string lsName, string lsTicket)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.GetLastError(lsTicket);
        }
        ...
        public static string InteractiveDone(string lsName, string lsTicket)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.InteractiveDone(lsTicket);
        }
        ...
        public static string InteractiveRejected(string lsName, string lsTicket, string lsReason)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.InteractiveRejected(lsTicket, lsReason);
        }
        ...
        public static int ReceiveResponseXML(string lsName, string lsTicket, string lsResponse, string lsResult, string lsMessage)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.ReceiveResponseXML(lsTicket, lsResponse, lsResult, lsMessage);
        }
        ...
        public static string SendRequestXML(string lsName, string lsTicket, string lsResponse, string lsCompanyFileName, string lsXMLCountry, int lsXMLMajorVers, int lsXMLMinorVers)
        {
            IMaxQuickbooksWebConnectProviderLibrary loProvider = Instance.GetProvider(lsName);
            return loProvider.SendRequestXML(lsTicket, lsResponse, lsCompanyFileName, lsXMLCountry, lsXMLMajorVers, lsXMLMinorVers);
        }


        /// <summary>
        /// Gets the provider based on the name
        /// </summary>
        /// <param name="lsName">Name of the provider</param>
        /// <returns>A provider based on the name.</returns>
        public virtual IMaxQuickbooksWebConnectProviderLibrary GetProvider(string lsName)
        {
            //// Try to create the provider specific to the Data Model.
            IMaxProvider loProvider = this.GetProviderByName(lsName, typeof(MaxFactry.Provider.QuickbooksProvider.Provider.MaxQuickbooksWebConnectProviderDefaultLibrary));

            IMaxQuickbooksWebConnectProviderLibrary loR = loProvider as IMaxQuickbooksWebConnectProviderLibrary;
            if (null == loR)
            {
